...
-- -----------------------------------------------------
-- Table `demo`.`calendars`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `demo`.`calendars` ;

CREATE TABLE IF NOT EXISTS `demo`.`calendars` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `id_user` INT(11) NULL,
...
CREATE INDEX `fk_calendar_users1_idx` ON `demo`.`calendars` (`id_user` ASC);
