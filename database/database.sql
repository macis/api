...
START TRANSACTION;
USE `demo`;
INSERT INTO `demo`.`users` (`id`, `username`, `password`, `authenticator`, `id_organization`, `title`, `firstname`, `lastname`, `email`) VALUES (1, 'root', DEFAULT, DEFAULT, 1, DEFAULT, DEFAULT, DEFAULT, DEFAULT);
